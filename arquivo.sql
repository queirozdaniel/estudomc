...
CREATE TABLE `cliente` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cpf_ou_cmpj` varchar(255) DEFAULT NULL,
...
INSERT INTO `cliente` VALUES (1,'123.456.678-00','maria@gmail','Maria Silva',1);
...
INSERT INTO `endereco` VALUES (1,'Jardim','30220834','Apt 203','Rua Flores','300',1,1),(2,'Centro','38777012','Sala 800','Av. Matos','105',2,1);
...
INSERT INTO `pedido` VALUES (1,'2017-09-30 10:32:00',1,1),(2,'2017-10-10 19:20:00',1,2);
...
INSERT INTO `produto` VALUES (1,'Computador',2000),(2,'Impressora',800),(3,'Mouse',80),(4,'Mesa de escritório',300),(5,'Toalha',50),(6,'Colcha',200),(7,'TV true color',1200),(8,'Roçadeira',800),(9,'Abajuor',100),(10,'Pendente',180),(11,'Shampoo',90);
...
INSERT INTO `telefone` VALUES (1,'30052205'),(1,'9391192324');
...
-- Dump completed on 2018-05-31 23:37:02
